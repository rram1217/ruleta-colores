 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var G_;function Tb(){if(G_)return Rt;G_=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),f=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),y=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),b=Symbol.iterator;function D(w){return w===null||typeof w!="object"?null:(w=b&&w[b]||w["@@iterator"],typeof w=="function"?w:null)}var q={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},H=Object.assign,$={};function F(w,Q,st){this.props=w,this.context=Q,this.refs=$,this.updater=st||q}F.prototype.isReactComponent={},F.prototype.setState=function(w,Q){if(typeof w!="object"&&typeof w!="function"&&w!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,w,Q,"setState")},F.prototype.forceUpdate=function(w){this.updater.enqueueForceUpdate(this,w,"forceUpdate")};function et(){}et.prototype=F.prototype;function it(w,Q,st){this.props=w,this.context=Q,this.refs=$,this.updater=st||q}var ot=it.prototype=new et;ot.constructor=it,H(ot,F.prototype),ot.isPureReactComponent=!0;var At=Array.isArray,ut={H:null,A:null,T:null,S:null,V:null},wt=Object.prototype.hasOwnProperty;function O(w,Q,st,nt,ht,It){return st=It.ref,{$$typeof:r,type:w,key:Q,ref:st!==void 0?st:null,props:It}}function S(w,Q){return O(w.type,Q,void 0,void 0,void 0,w.props)}function C(w){return typeof w=="object"&&w!==null&&w.$$typeof===r}function V(w){var Q={"=":"=0",":":"=2"};return"$"+w.replace(/[=:]/g,function(st){return Q[st]})}var N=/\/+/g;function P(w,Q){return typeof w=="object"&&w!==null&&w.key!=null?V(""+w.key):Q.toString(36)}function I(){}function ne(w){switch(w.status){case"fulfilled":return w.value;case"rejected":throw w.reason;default:switch(typeof w.status=="string"?w.then(I,I):(w.status="pending",w.then(function(Q){w.status==="pending"&&(w.status="fulfilled",w.value=Q)},function(Q){w.status==="pending"&&(w.status="rejected",w.reason=Q)})),w.status){case"fulfilled":return w.value;case"rejected":throw w.reason}}throw w}function Zt(w,Q,st,nt,ht){var It=typeof w;(It==="undefined"||It==="boolean")&&(w=null);var yt=!1;if(w===null)yt=!0;else switch(It){case"bigint":case"string":case"number":yt=!0;break;case"object":switch(w.$$typeof){case r:case t:yt=!0;break;case E:return yt=w._init,Zt(yt(w._payload),Q,st,nt,ht)}}if(yt)return ht=ht(w),yt=nt===""?"."+P(w,0):nt,At(ht)?(st="",yt!=null&&(st=yt.replace(N,"$&/")+"/"),Zt(ht,Q,st,"",function(kn){return kn})):ht!=null&&(C(ht)&&(ht=S(ht,st+(ht.key==null||w&&w.key===ht.key?"":(""+ht.key).replace(N,"$&/")+"/")+yt)),Q.push(ht)),1;yt=0;var _e=nt===""?".":nt+":";if(At(w))for(var Ft=0;Ft<w.length;Ft++)nt=w[Ft],It=_e+P(nt,Ft),yt+=Zt(nt,Q,st,It,ht);else if(Ft=D(w),typeof Ft=="function")for(w=Ft.call(w),Ft=0;!(nt=w.next()).done;)nt=nt.value,It=_e+P(nt,Ft++),yt+=Zt(nt,Q,st,It,ht);else if(It==="object"){if(typeof w.then=="function")return Zt(ne(w),Q,st,nt,ht);throw Q=String(w),Error("Objects are not valid as a React child (found: "+(Q==="[object Object]"?"object with keys {"+Object.keys(w).join(", ")+"}":Q)+"). If you meant to render a collection of children, use an array instead.")}return yt}function K(w,Q,st){if(w==null)return w;var nt=[],ht=0;return Zt(w,nt,"","",function(It){return Q.call(st,It,ht++)}),nt}function rt(w){if(w._status===-1){var Q=w._result;Q=Q(),Q.then(function(st){(w._status===0||w._status===-1)&&(w._status=1,w._result=st)},function(st){(w._status===0||w._status===-1)&&(w._status=2,w._result=st)}),w._status===-1&&(w._status=0,w._result=Q)}if(w._status===1)return w._result.default;throw w._result}var dt=typeof reportError=="function"?reportError:function(w){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Q=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof w=="object"&&w!==null&&typeof w.message=="string"?String(w.message):String(w),error:w});if(!window.dispatchEvent(Q))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",w);return}console.error(w)};function Pt(){}return Rt.Children={map:K,forEach:function(w,Q,st){K(w,function(){Q.apply(this,arguments)},st)},count:function(w){var Q=0;return K(w,function(){Q++}),Q},toArray:function(w){return K(w,function(Q){return Q})||[]},only:function(w){if(!C(w))throw Error("React.Children.only expected to receive a single React element child.");return w}},Rt.Component=F,Rt.Fragment=n,Rt.Profiler=o,Rt.PureComponent=it,Rt.StrictMode=s,Rt.Suspense=y,Rt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=ut,Rt.__COMPILER_RUNTIME={__proto__:null,c:function(w){return ut.H.useMemoCache(w)}},Rt.cache=function(w){return function(){return w.apply(null,arguments)}},Rt.cloneElement=function(w,Q,st){if(w==null)throw Error("The argument must be a React element, but you passed "+w+".");var nt=H({},w.props),ht=w.key,It=void 0;if(Q!=null)for(yt in Q.ref!==void 0&&(It=void 0),Q.key!==void 0&&(ht=""+Q.key),Q)!wt.call(Q,yt)||yt==="key"||yt==="__self"||yt==="__source"||yt==="ref"&&Q.ref===void 0||(nt[yt]=Q[yt]);var yt=arguments.length-2;if(yt===1)nt.children=st;else if(1<yt){for(var _e=Array(yt),Ft=0;Ft<yt;Ft++)_e[Ft]=arguments[Ft+2];nt.children=_e}return O(w.type,ht,void 0,void 0,It,nt)},Rt.createContext=function(w){return w={$$typeof:f,_currentValue:w,_currentValue2:w,_threadCount:0,Provider:null,Consumer:null},w.Provider=w,w.Consumer={$$typeof:u,_context:w},w},Rt.createElement=function(w,Q,st){var nt,ht={},It=null;if(Q!=null)for(nt in Q.key!==void 0&&(It=""+Q.key),Q)wt.call(Q,nt)&&nt!=="key"&&nt!=="__self"&&nt!=="__source"&&(ht[nt]=Q[nt]);var yt=arguments.length-2;if(yt===1)ht.children=st;else if(1<yt){for(var _e=Array(yt),Ft=0;Ft<yt;Ft++)_e[Ft]=arguments[Ft+2];ht.children=_e}if(w&&w.defaultProps)for(nt in yt=w.defaultProps,yt)ht[nt]===void 0&&(ht[nt]=yt[nt]);return O(w,It,void 0,void 0,null,ht)},Rt.createRef=function(){return{current:null}},Rt.forwardRef=function(w){return{$$typeof:g,render:w}},Rt.isValidElement=C,Rt.lazy=function(w){return{$$typeof:E,_payload:{_status:-1,_result:w},_init:rt}},Rt.memo=function(w,Q){return{$$typeof:p,type:w,compare:Q===void 0?null:Q}},Rt.startTransition=function(w){var Q=ut.T,st={};ut.T=st;try{var nt=w(),ht=ut.S;ht!==null&&ht(st,nt),typeof nt=="object"&&nt!==null&&typeof nt.then=="function"&&nt.then(Pt,dt)}catch(It){dt(It)}finally{ut.T=Q}},Rt.unstable_useCacheRefresh=function(){return ut.H.useCacheRefresh()},Rt.use=function(w){return ut.H.use(w)},Rt.useActionState=function(w,Q,st){return ut.H.useActionState(w,Q,st)},Rt.useCallback=function(w,Q){return ut.H.useCallback(w,Q)},Rt.useContext=function(w){return ut.H.useContext(w)},Rt.useDebugValue=function(){},Rt.useDeferredValue=function(w,Q){return ut.H.useDeferredValue(w,Q)},Rt.useEffect=function(w,Q,st){var nt=ut.H;if(typeof st=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return nt.useEffect(w,Q)},Rt.useId=function(){return ut.H.useId()},Rt.useImperativeHandle=function(w,Q,st){return ut.H.useImperativeHandle(w,Q,st)},Rt.useInsertionEffect=function(w,Q){return ut.H.useInsertionEffect(w,Q)},Rt.useLayoutEffect=function(w,Q){return ut.H.useLayoutEffect(w,Q)},Rt.useMemo=function(w,Q){return ut.H.useMemo(w,Q)},Rt.useOptimistic=function(w,Q){return ut.H.useOptimistic(w,Q)},Rt.useReducer=function(w,Q,st){return ut.H.useReducer(w,Q,st)},Rt.useRef=function(w){return ut.H.useRef(w)},Rt.useState=function(w){return ut.H.useState(w)},Rt.useSyncExternalStore=function(w,Q,st){return ut.H.useSyncExternalStore(w,Q,st)},Rt.useTransition=function(){return ut.H.useTransition()},Rt.version="19.1.1",Rt}var Q_;function Mm(){return Q_||(Q_=1,zd.exports=Tb()),zd.exports}var re=Mm();const Eb=GT(re);var jd={exports:{}},Sl={},Bd={exports:{}},qd={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gt(r,t,n){let s="Unexpected state";typeof t=="string"?s=t:n=t,gE(r,s,n)}function gE(r,t,n){let s=`FIRESTORE (${co}) INTERNAL ASSERTION FAILED: ${t} (ID: ${r.toString(16)})`;if(n!==void 0)try{s+=" CONTEXT: "+JSON.stringify(n)}catch{s+=" CONTEXT: "+n}throw Ki(s),new Error(s)}function Lt(r,t,n,s){let o="Unexpected state";typeof n=="string"?o=n:s=n,r||gE(t,o,s)}function St(r,t){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class UI{constructor(){this.wa=void 0,this.Sa=[]}ba(){return this.Sa.some((t=>t.Da()))}}class LI{constructor(){this.queries=Zv(),this.onlineState="Unknown",this.Ca=new Set}terminate(){(function(n,s){const o=St(n),u=o.queries;o.queries=Zv(),u.forEach(((f,g)=>{for(const y of g.Sa)y.onError(s)}))})(this,new at(X.ABORTED,"Firestore shutting down"))}}function Zv(){return new Js((r=>kE(r)),yh)}async function _0(r,t){const n=St(r);let s=3;const o=t.query;let u=n.queries.get(o);u?!u.ba()&&t.Da()&&(s=2):(u=new UI,s=t.Da()?0:1);try{switch(s){case 0:u.wa=await n.onListen(o,!0);break;case 1:u.wa=await n.onListen(o,!1);break;case 2:await n.onFirstRemoteStoreListen(o)}}catch(f){const g=rg(f,`Initialization of query '${Qa(t.query)}' failed`);return void t.onError(g)}n.queries.set(o,u),u.Sa.push(t),t.va(n.onlineState),u.wa&&t.Fa(u.wa)&&sg(n)}async function v0(r,t){const n=St(r),s=t.query;let o=3;const u=n.queries.get(s);if(u){const f=u.Sa.indexOf(t);f>=0&&(u.Sa.splice(f,1),u.Sa.length===0?o=t.Da()?0:1:!u.ba()&&t.Da()&&(o=2))}switch(o){case 0:return n.queries.delete(s),n.onUnlisten(s,!0);case 1:return n.queries.delete(s),n.onUnlisten(s,!1);case 2:return n.onLastRemoteStoreUnlisten(s);default:return}}function zI(r,t){const n=St(r);let s=!1;for(const o of t){const u=o.query,f=n.queries.get(u);if(f){for(const g of f.Sa)g.Fa(o)&&(s=!0);f.wa=o}}s&&sg(n)}function jI(r,t,n){const s=St(r),o=s.queries.get(t);if(o)for(const u of o.Sa)u.onError(n);s.queries.delete(t)}function sg(r){r.Ca.forEach((t=>{t.next()}))}var Sm,Jv;(Jv=Sm||(Sm={})).Ma="default",Jv.Cache="cache";class T0{constructor(t,n,s){this.query=t,this.xa=n,this.Oa=!1,this.Na=null,this.onlineState="Unknown",this.options=s||{}}Fa(t){if(!this.options.includeMetadataChanges){const s=[];for(const o of t.docChanges)o.type!==3&&s.push(o);t=new ao(t.query,t.docs,t.oldDocs,s,t.mutatedKeys,t.fromCache,t.syncStateChanged,!0,t.hasCachedResults)}let n=!1;return this.Oa?this.Ba(t)&&(this.xa.next(t),n=!0):this.La(t,this.onlineState)&&(this.ka(t),n=!0),this.Na=t,n}onError(t){this.xa.error(t)}va(t){this.onlineState=t;let n=!1;return this.Na&&!this.Oa&&this.La(this.Na,t)&&(this.ka(this.Na),n=!0),n}La(t,n){if(!t.fromCache||!this.Da())return!0;const s=n!=="Offline";return(!this.options.qa||!s)&&(!t.docs.isEmpty()||t.hasCachedResults||n==="Offline")}Ba(t){if(t.docChanges.length>0)return!0;const n=this.Na&&this.Na.hasPendingWrites!==t.hasPendingWrites;return!(!t.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}ka(t){t=ao.fromInitialDocuments(t.query,t.docs,t.mutatedKeys,t.fromCache,t.hasCachedResults),this.Oa=!0,this.xa.next(t)}Da(){return this.options.source!==Sm.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const FN=300,GN=ZT("authIdTokenMaxAge")||FN;let jT=null;const QN=r=>async t=>{const n=t&&await t.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>GN)return;const o=n?.token;jT!==o&&(jT=o,await fetch(r,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function KN(r=xm()){const t=Zs(r,"auth");if(t.isInitialized())return t.getImmediate();const n=bD(r,{popupRedirectResolver:jN,persistence:[ZD,zD,kA]}),s=ZT("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const u=new URL(s,location.origin);if(location.origin===u.origin){const f=QN(u.toString());kD(n,f,()=>f(n.currentUser)),PD(n,g=>f(g))}}const o=$T("auth");return o&&RD(n,`http://${o}`),n}function YN(){return document.getElementsByTagName("head")?.[0]??document}TD({loadJS(r){return new Promise((t,n)=>{const s=document.createElement("script");s.setAttribute("src",r),s.onload=t,s.onerror=o=>{const u=pi("internal-error");u.customData=o,n(u)},s.type="text/javascript",s.charset="UTF-8",YN().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});HN("Browser");const js={apiKey:"AIzaSyASowKpD20sEZPA33VG5Mxy0KuJeFIziT4",authDomain:"ruleta-colores.firebaseapp.com",projectId:"ruleta-colores",storageBucket:"ruleta-colores.firebasestorage.app",messagingSenderId:"1088398378468",appId:"1:1088398378468:web:ffe2a14beab711aed573f1",measurementId:"G-NV2GD0KQKC"},$N={apiKey:js.apiKey,authDomain:js.authDomain,projectId:js.projectId,storageBucket:js.storageBucket,messagingSenderId:js.messagingSenderId,appId:js.appId,measurementId:js.measurementId},Ng=aE($N),Bi=dC(Ng),XN=KN(Ng);OD(XN).catch(r=>{console.error("Anonymous sign-in failed:",r)});typeof window<"u"&&Q2(Ng);const BT="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",ZN=(r=6)=>Array.from({length:r},()=>BT[Math.floor(Math.random()*BT.length)]).join("");function HA(r){const t=Dc(Bi,"rooms",r),n=H=>wC(t,$=>{if(!$.exists())return H(null);const F=$.data();H({colors:F.colors||[],customColors:F.customColors||{},history:F.history||[],flash:F.flash||null,code:F.code||""})}),s=async(H,$=[],F={})=>{H&&await Wd(t,{colors:$,customColors:F,history:[],updatedAt:bl()},{merge:!0})},o=H=>tm(Bi,async $=>{const F=await $.get(t),et=F.exists()?F.data():{colors:[],history:[],customColors:{},flash:null},it=H({colors:et.colors||[],history:et.history||[],customColors:et.customColors||{},flash:et.flash||null});$.set(t,{...it,updatedAt:bl()},{merge:!0})});return{watch:n,initIfNeeded:s,addColor:async H=>{await o(({colors:$,history:F,customColors:et,flash:it})=>$.includes(H)?{colors:$,history:F,customColors:et,flash:it}:{colors:[...$,H],history:F,customColors:et,flash:it})},removeColor:async H=>{await o(({colors:$,history:F,customColors:et})=>{const it=$.filter(At=>At!==H),ot={...et};return delete ot[H],{colors:it,history:F,customColors:ot,flash:null}})},updateCustomColor:async(H,$)=>{await o(({colors:F,history:et,customColors:it,flash:ot})=>({colors:F,history:et,flash:ot,customColors:{...it,[H]:$}}))},pushHistoryAndFlash:async(H,$,F)=>{const et=Date.now();return await o(({colors:it,history:ot,customColors:At})=>{if(!it.includes(H))return{colors:it,history:ot,customColors:At,flash:null};const ut=[...ot||[],{color:H,ts:et,by:$}];return{colors:it,history:ut,customColors:At,flash:{color:H,ts:et,duration:F}}}),et},removeAfterFlashIfNotLast:async H=>{await o(({colors:$,history:F,customColors:et,flash:it})=>{const ot=it&&it.color===H;return{colors:$.length===1?$:$.filter(ut=>ut!==H),history:F,customColors:et,flash:ot?null:it}})},reset:async()=>{await o(({colors:H,history:$,customColors:F})=>({colors:[...new Set([...H,...$.map(it=>it.color)])],history:[],customColors:F,flash:null}))},ensureRoomCode:async H=>{const $=await gT(cT(sT(Bi,"codes"),hT("roomId","==",r),fT(1)));let F=$.empty?"":$.docs[0].id;return!F&&H?await tm(Bi,async et=>{for(let it=0;it<5;it++){const ot=ZN(6),At=Dc(Bi,"codes",ot);if(!(await et.get(At)).exists()){F=ot,et.set(At,{roomId:r,createdAt:bl()}),et.set(t,{code:F},{merge:!0});return}}throw new Error("No se pudo generar c�digo �nico.")}):F&&await Wd(t,{code:F},{merge:!0}),F},createRoom:async({initialColors:H=[],customColors:$={}}={})=>{const F=`r${Date.now().toString(36)}${Math.random().toString(36).slice(2,6)}`,et=Dc(Bi,"rooms",F);await Wd(et,{colors:H,customColors:$,history:[],updatedAt:bl()},{merge:!0});const it="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",ot=(ut=6)=>Array.from({length:ut},()=>it[Math.floor(Math.random()*it.length)]).join("");let At="";return await tm(Bi,async ut=>{for(let wt=0;wt<5;wt++){const O=ot(6),S=Dc(Bi,"codes",O);if(!(await ut.get(S)).exists()){At=O,ut.set(S,{roomId:F,createdAt:bl()}),ut.set(et,{code:At},{merge:!0});return}}throw new Error("No se pudo generar c�digo �nico.")}),{roomId:F,code:At}},resolveRoomIdByCode:async H=>{const $=await gT(cT(sT(Bi,"codes"),hT("__name__","==",H),fT(1)));return $.empty?null:$.docs[0].data()?.roomId??null}}}function JN(){const[r,t]=re.useState(!1),[n,s]=re.useState(!1),[o,u]=re.useState(""),[f,g]=re.useState(""),[y,p]=re.useState(""),E=HA("dummy"),b=window.location.origin+window.location.pathname,D=async()=>{p("");const H=o.trim();if(!H){p("Escribe tu nombre (administrador)");return}t(!0);try{const{roomId:$,code:F}=await E.createRoom({initialColors:["Rojo","Azul","Verde","Amarillo","Naranja","Blanco/Morado","Negro","Rosa"],createdBy:H}),et=`${b}?room=${encodeURIComponent($)}`,it=`${b}?room=${encodeURIComponent($)}&mode=public`;alert(`✅ Sala creada
